...
const notVerified = { success: false, user, message: "Non verified email. Check your inbox or spam." }
const loggedIn = { success: true, user, message: "Login successful" }
const wrongPassword = { success: false, user, message: "Wrong password" }
...
const successfulSend = { success: true, user, message: "Email sent successfully!" }
const successfulResend = { success: true, user, message: "Email resent successfully!" }
